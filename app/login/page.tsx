    ...
    <div className="flex min-h-[100svh] items-center justify-center px-4 py-6 sm:py-12" style={{ background: 'linear-gradient(135deg, #4a1f60 0%, #6d2f8e 60%, #3a1750 100%)' }}>
      <div className="w-full max-w-lg">
        <div className="mb-5 text-center">
          ...
          <p className="mt-3 text-sm" style={{ color: 'rgba(255,255,255,0.55)' }}>OAKBERRY Internal Portal</p>
        </div>

        <div className="mb-6 rounded-3xl bg-white p-6 shadow-2xl sm:p-8">
          <div className="mb-5 flex items-center gap-3">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl" style={{ background: 'linear-gradient(135deg, #4a1f60, #6d2f8e)' }}>
              <svg className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
              </svg>
            </div>
            <div>
              <h2 className="text-lg font-semibold leading-tight text-slate-900">Sign in</h2>
              <p className="text-xs text-slate-400">Access the OAKBERRY Internal Portal</p>
            </div>
          </div>
        ...
        <p className="text-center text-xs" style={{ color: 'rgba(255,255,255,0.5)' }}>
          After sign-in, choose the internal platform you want to open.
        </p>
      </div>
    </div>
  );

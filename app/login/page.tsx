    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'linear-gradient(135deg, #4a1f60 0%, #6d2f8e 60%, #3a1750 100%)' }}>
      <div className="flex items-center justify-center pt-14 pb-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm" style={{ color: 'rgba(255,255,255,0.65)' }}>Internal Tools Portal</p>
        </div>
      </div>
      ...
      <div className="px-4 pb-8">
        <div className="mx-auto grid w-full max-w-4xl grid-cols-2 gap-4 sm:grid-cols-4">
          ...
          {/* OPEX — active */}
          <div className="flex flex-col items-center rounded-2xl p-5 text-center transition-all cursor-default"
            ...
            <p className="mt-1 text-xs" style={{ color: 'rgba(255,255,255,0.6)' }}>Operational Expenditure</p>
            <span className="mt-3 rounded-full px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider"
          ...
          <div className="flex flex-col items-center rounded-2xl p-5 text-center opacity-70"
            style={{ background: 'rgba(255,255,255,0.07)', border: '1px solid rgba(255,255,255,0.12)' }}>
            <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-xl"
              style={{ background: 'rgba(255,255,255,0.1)' }}>
              <svg className="h-6 w-6 text-white/70" fill="none" viewBox="0 0 24 24" strokeWidth={1.8} stroke="currentColor">
            ...
            <p className="mt-1 text-xs" style={{ color: 'rgba(255,255,255,0.45)' }}>Team &amp; Culture</p>
            <span className="mt-3 rounded-full px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider"
          ...
          <div className="flex flex-col items-center rounded-2xl p-5 text-center opacity-70"
            ...
            <p className="mt-1 text-xs" style={{ color: 'rgba(255,255,255,0.45)' }}>Hiring &amp; Onboarding</p>
            <span className="mt-3 rounded-full px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider"
              style={{ background: 'rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.5)', border: '1px solid rgba(255,255,255,0.12)' }}>
              Coming Soon
            </span>
          ...
          <div className="flex flex-col items-center rounded-2xl p-5 text-center opacity-70"
            ...
            <p className="mt-1 text-xs" style={{ color: 'rgba(255,255,255,0.45)' }}>People &amp; Policies</p>
            <span className="mt-3 rounded-full px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider"
              style={{ background: 'rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.5)', border: '1px solid rgba(255,255,255,0.12)' }}>
              Coming Soon
            </span>

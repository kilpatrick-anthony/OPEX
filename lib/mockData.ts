...
const CATEGORY_TRENDS: Record<string, TrendPoint[]> = {
  ...
  'software-licenses': [{ month: 'Nov', total: 980 }, { month: 'Dec', total: 1120 }, { month: 'Jan', total: 1010 }, { month: 'Feb', total: 1080 }, { month: 'Mar', total: 1260 }, { month: 'Apr', total: 1180 }],
  repairs: [{ month: 'Nov', total: 1600 }, { month: 'Dec', total: 1810 }, { month: 'Jan', total: 1490 }, { month: 'Feb', total: 1720 }, { month: 'Mar', total: 2100 }, { month: 'Apr', total: 1940 }],
  'courier-and-delivery': [{ month: 'Nov', total: 560 }, { month: 'Dec', total: 640 }, { month: 'Jan', total: 540 }, { month: 'Feb', total: 590 }, { month: 'Mar', total: 720 }, { month: 'Apr', total: 680 }],
  events: [{ month: 'Nov', total: 820 }, { month: 'Dec', total: 960 }, { month: 'Jan', total: 770 }, { month: 'Feb', total: 860 }, { month: 'Mar', total: 1080 }, { month: 'Apr', total: 990 }],
...
export const DASHBOARD_MOCK: Record<string, any> = {
  month: {
    ...
    byCategory: [
      ...
      { category: 'Software Licenses', slug: 'software-licenses', total: 1180 },
      { category: 'Repairs', slug: 'repairs', total: 1940 },
      { category: 'Courier and Delivery', slug: 'courier-and-delivery', total: 680 },
      { category: 'Events', slug: 'events', total: 990 },
  ...
  'last-month': {
    ...
    byCategory: [
      ...
      { category: 'Software Licenses', slug: 'software-licenses', total: 1120 },
      { category: 'Repairs', slug: 'repairs', total: 1810 },
      { category: 'Courier and Delivery', slug: 'courier-and-delivery', total: 640 },
      { category: 'Events', slug: 'events', total: 960 },
  ...
  quarter: {
    ...
    byCategory: [
      ...
      { category: 'Software Licenses', slug: 'software-licenses', total: 3450 },
      { category: 'Repairs', slug: 'repairs', total: 5810 },
      { category: 'Courier and Delivery', slug: 'courier-and-delivery', total: 2210 },
      { category: 'Events', slug: 'events', total: 2930 },
